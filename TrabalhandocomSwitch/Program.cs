...
namespace TrabalhandocomSwitch
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Escolha o transporte para ir trabalhar: [m]Moto | [c]Carro | [o]Ônibus");
            ...
            {
                Console.WriteLine("Transpoetr inválido");
            }

            Console.WriteLine("\nDeseja conitinuar com o programa: [s/n]");
            escolha = char.Parse(Console.ReadLine());
